...
const ManageClasses = () => {
    ...
    return (
        <div className="pt-20 pb-36 text-center p-[65px]">
            ...
            <h1 className="text-start pl-8 text-2xl pb-8">Total Selected Classes: {classes.length}</h1>
            <div className="grid grid-cols-2 gap-x-5">
                {
                    classes.map(singleClass => <div key={singleClass._id} className="card card-side bg-neutral-100 shadow-2xl p-5 mb-8 space-x-5  justify-between items-center">
                        ...
                        <div className="flex flex-wrap justify-end space-y-5">
                            ...
                            <button className="btn bg-sky-700 border-none text-stone-200 w-28 text-base">Feedback</button>
                        </div>
